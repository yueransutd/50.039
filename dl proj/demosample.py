...
def run(imgDir):
    ...
    parser.add_argument('--encoder_path', type=str, default='encoder-5-3000.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='decoder-5-3000.ckpt', help='path for trained decoder')
